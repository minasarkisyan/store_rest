...
Route::post('liked', [\App\Http\Controllers\LikedReviewsController::class, 'store']);
Route::delete('liked/{id}', [\App\Http\Controllers\LikedReviewsController::class, 'destroy']);
